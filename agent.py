...
class Agent:
    def __init__(self, agentID, birthday, cell, configuration):
        ...
        self.cognitiveFactor = configuration["cognitiveFactor"]
        ...
        self.emotionalFactor = configuration["emotionalFactor"]
        ...
        self.physicalFactor = configuration["physicalFactor"]
        self.seed = configuration["seed"]
        self.selfishnessFactor = configuration["selfishnessFactor"]
        self.sex = configuration["sex"]
        self.socialFactor = configuration["socialFactor"]
